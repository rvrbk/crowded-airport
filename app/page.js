...
import ThingSearch from './components/ThingSearch';
        ...
        <div className={`flex items-center justify-center h-dvh bg-gray-100`}>
            ...
            <div className="w-full max-w-xs">
                <div className="relative">
                    ...
                    {activeForm !== 'thing' && <AirportSearch 
                        airports={airports}
                        selectedAirport={selectedAirport}
                        handleAirportChange={handleAirportChange} 
                        handleWhereAmIClick={handleWhereAmIClick}
                        activeForm={activeForm}
                    />}
                    {activeForm === 'thing-search' && <ThingSearch
                        things={things}
                        selectedThing={selectedThing}
                        handleThingChange={handleThingChange}
                        setActiveForm={setActiveForm}
                    />}
                    {activeForm === 'add-thing' && <AddThing 
                        setActiveForm={setActiveForm}
